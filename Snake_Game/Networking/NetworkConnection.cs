...
public sealed class NetworkConnection : IDisposable
{
    ...
    /// <summary>
    /// creates the reader and writer from the _tcpClient
    /// don't use is tcpclient not set
    /// </summary>
    ...
    public bool IsConnected
    {
        get
        {
            //Console.WriteLine("IsConnected" + _tcpClient != null && _tcpClient.Client != null && _tcpClient.Client.Connected);
    ...
    public void Send( string message )
    {
        ...
        if (_writer == null)
            throw new InvalidOperationException("writer for network connection is null");
        else
        {
    ...
    {
        if (_reader == null)
            throw new InvalidOperationException("reader for network connection is null");
        else
        {
